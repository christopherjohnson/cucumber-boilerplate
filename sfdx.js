...
//var Promise = require("bluebird"); // Bluebird is a promise library.    var fs = require('fs'),
...
module.exports = (function() {
    ...
    const getSessionLoginUrl = function(brower) {
    ...
    return {
        baseUrl: baseUrl,
        getSessionLoginUrl: getSessionLoginUrl
    };
})();
